...
var comments = map[string]string{
	...
	"Cluster.FindQmHash":       "Called in broadcast from FindQmHash",
	"Cluster.AutoLogin":        "Called in broadcast from AutoLogin",
	"Cluster.UidNew":     "Called in UidNew",
	"Cluster.UidLogin":   "Called in UidLogin",
	"Cluster.FileGet":    "Called in FileGet",
	"Cluster.FilesCp":    "Called in FilesCp",
	"Cluster.FilesFlush": "Called in FilesFlush",
	"Cluster.FilesLs":    "Called in FilesLs",
	"Cluster.FilesMkdir": "Called in FilesMkdir",
	"Cluster.FilesRead":   "Called in FilesRead",
	"Cluster.FilesRm":     "Called in FilesRm",
	"Cluster.FilesStat":   "Called in FilesStat",
	"Cluster.FilesMv":     "Called in FilesMv",
	"Cluster.FilesWrite":  "Called in FilesWrite",
